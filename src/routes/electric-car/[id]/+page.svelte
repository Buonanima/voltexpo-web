...
<div class="container">
	<nav class="breadcrumb">
		<button class="back-btn" on:click={goBack}> ← Back to Cars </button>
	</nav>

	<article class="car-detail">
		<div class="car-images">
			<img src={car.main_picture_url} alt={car.title} class="main-image" />
		</div>
		...
		<div class="car-info">
			<header class="car-header">
				...
				<HeartButton isLiked={carWithLikeState.isLiked} size="large" onclick={handleHeartClick} />
			</header>
